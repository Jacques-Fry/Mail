...
.goods-table tr td:nth-of-type(1) {
  padding-left: 5px;
  font-size: 13px;
  width: 60px;
}

.goods-table tr td:nth-of-type(2) {
  color: #000;
  font-size: 13px;
}
